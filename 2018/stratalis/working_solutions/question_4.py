"""
For this one I seem to have had just one minor error, which was to accidentally have swapped the code for moving
right and moving left.  Swapping lines 46 and 56 (as numbered in this file) was literally all I needed to do to get the
example case working.  Of course this is not to say that the other test cases would have definitely passed.
"""
